...
export default () => (
  <div className="projects">
    ...
    <KnowledgeSection>
      <KnowledgeItem title="JavaScript" img="images/js_logo.png">I began my JavaScript journey in the winter of 2016 and have since been using it for nearly all of my projects.</KnowledgeItem>
      ...
      <KnowledgeItem title="Redux" img="images/redux_logo.png">I learned Redux as a necessity for my job in summer of 2017, I have been working with it professionally for around half a year. For my personal projects I tend to be cautious due to how much redux unnecessarily complicates smaller projects, although I definetly take advantage of it's benefits in projects with more complex application state.</KnowledgeItem>
    ...
    <KnowledgeSection yellow>
      ...
      <KnowledgeItem title="Java" img="images/java_logo.png">Java is the first programming language I learned, it is also the primary programming language used at my university. I’ve never professionally worked with Java but I’ve worked on many small projects with it.</KnowledgeItem>
    </KnowledgeSection>
    <Spacer />
  </div>
)
