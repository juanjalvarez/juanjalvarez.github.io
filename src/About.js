    ...
    return (
      <div className="about-container">
        ...
        <Paragraph title="About Me">
          I have two dogs (Jellybean & Jaruby), my car is a black Mitsubishi Lancer and I love video games (Right now I’m crazed with PUBG, I mostly play strategy games but I have a softspot for anything survival based). My favourite color is black (I bet you didn’t see that one coming), I love Papa John’s cheese-exclusive pizza, fruit smoothies and anything and everything avocadoes. My immediate-future dream car is a Ford Mustang V6, and a little farther out I will want the Tesla Model-S equivalent of the future, not that I’m a car guy I just like things that go fast. Speaking of fast, I am a huge fan of rollercoasters, my favourite rollercoaster is the Rock ’n’ Roller Coaster from Hollywood Studios at Disney, the take-off is absolutely ridiculous.
        </Paragraph>
        {
          this.state.showBio ?
            this.renderBio()
